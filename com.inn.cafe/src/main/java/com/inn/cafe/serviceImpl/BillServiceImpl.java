...
public class BillServiceImpl implements BillService {
    ...
    private Font getFront(String type) {
        switch (type){
            case "Header": Font headerFront = FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE,18,BaseColor.BLACK);
            headerFront.setStyle(Font.BOLD);
            return headerFront;

            case "Data": Font dataFront = FontFactory.getFont(FontFactory.TIMES_ROMAN,11,BaseColor.BLACK);
